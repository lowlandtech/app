...
namespace Spotacard.Migrations
{
    ...
    [Migration("20200317043512_Update_Stack_Relations")]
    partial class Update_Stack_Relations
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Spotacard.Domain.Content", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Spotacard.Domain.Relation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid>("FkFieldId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("FkFieldId");

                    b.HasIndex("PkFieldId");

                    b.ToTable("Relations");
                });

            modelBuilder.Entity("Spotacard.Domain.Stack", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Spotacard.Domain.Relation", b =>
                {
                    b.HasOne("Spotacard.Domain.Field", "FkField")
                        .WithMany("FkFields")
                        .HasForeignKey("FkFieldId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("Spotacard.Domain.Field", "PkField")
                        .WithMany("PkFields")
                        .HasForeignKey("PkFieldId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Spotacard.Domain.Stack", b =>
                {
                    ...
                    b.HasOne("Spotacard.Domain.Content", "Content")
                        .WithMany()
                        .HasForeignKey("ContentId");

                    b.HasOne("Spotacard.Domain.Stack", "Parent")
                        .WithMany("Children")
                        .HasForeignKey("ParentId");
                });
