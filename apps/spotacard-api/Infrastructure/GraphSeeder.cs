...
namespace Spotacard.Infrastructure
{
    ...
    public class GraphSeeder : ISeeder
    {
        ...
        public static readonly App Spotacard = new App
        {
        ...
        {
            Id = new Guid("1f1dc168-bae1-495a-9ac7-0e859aaaf227"),
            Title = "DotNet CQRS feature backend",
            Slug = "dotNet-cqrs-feature-backend",
            Type = CardTypes.Template
        };

        public static readonly Stack DotNetBackend = new Stack
        {
            Id = new Guid("944a666c-0727-4767-9891-11990ca86075"),
            Name = "DotNet CQRS feature backend",
            IsRoot = true,
            IsActive = true,
            CardId = Template.Id,
            Data = DataTypes.App,
            Type = StackTypes.Repository,
            Children = new List<Stack>
            {
                new Stack
                {
                    Id = new Guid("9ecf352f-c879-4e74-89b8-0d3a701a914b"),
                    Name = "Create repository",
                    Data = DataTypes.App,
                    Type = StackTypes.Command,
                    Content = new Content
                    {
                        Id = new Guid("a2b758e7-fc9f-4046-93e1-b3e64f12df90"),
                        Name = "1.0.1",
                        Text = "npx create-nx-workspace@latest @Model.Name.ToLower() --preset angular --appName @Model.Name.ToLower() --style scss --no-interactive --skip-install"
                    }
                },
                new Stack
                {
                    Id = new Guid("79115d0b-db5c-4019-aabd-3baba5161600"),
                    Name = "Create dotnet solution",
                    Data = DataTypes.App,
                    Type = StackTypes.Command,
                    Content = new Content
                    {
                        Id = new Guid("fa526a67-32af-4057-8098-29fbb9502b24"),
                        Name = "1.0.1",
                        Text = "dotnet new sln @Model.Name.ToLower()"
                    }
                },
                new Stack
                {
                    Id = new Guid("5de67d8f-737d-4d22-b544-b25ed8bef982"),
                    Name = "Create dotnet webapi",
                    Data = DataTypes.App,
                    Type = StackTypes.Command,
                    Content = new Content
                    {
                        Id = new Guid("4782dcdd-6f7e-4285-b577-3efde4d80c9a"),
                        Name = "1.0.1",
                        Text = "dotnet new webapi --name @Model.Name.ToLower() --output apps/@Model.Name.ToLower()"
                    }
                },
                new Stack
                {
                    Id = new Guid("e0f1d163-0a85-47c3-b388-dc0fc1096164"),
                    Name = "Add webapi to sln",
                    Data = DataTypes.App,
                    Type = StackTypes.Command,
                    Content = new Content
                    {
                        Id = new Guid("72754ef2-b137-49ab-b7b1-f5ffaf2a92cd"),
                        Name = "1.0.1",
                        Text = "dotnet sln add --project apps/@Model.Name.ToLower()"
                    }
                },
            }
        };

        public static readonly Relation Relation0 = new Relation
        {
        ...
        public static readonly Relation Relation1 = new Relation
        {
        ...
        public static readonly Relation Relation2 = new Relation
        {
        ...
        public static readonly Relation Relation3 = new Relation
        {
        ...
        public static readonly Relation Relation4 = new Relation
        {
        ...
        public static readonly Relation Relation5 = new Relation
        {
        ...
        public static readonly Relation Relation6 = new Relation
        {
        ...
        public static readonly Relation Relation7 = new Relation
        {
        ...
        public static readonly Relation Relation8 = new Relation
        {
        ...
        public static readonly Relation Relation9 = new Relation
        {
        ...
        public void Execute()
        {
            if (!_context.Apps.Any())
            {
                ...
                _context.Stacks.Add(DotNetBackend.Copy());
